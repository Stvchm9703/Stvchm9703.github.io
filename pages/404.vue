...
section.section.hero
  .__nuxt-error-page.hero-body
    .container.is-centered
      ...
      p.subtitle.is-size-3-desktop.is-size-5-touch.mb-0(
        v-if="targetPage !== 'error'"
      ) Maybe Not Your False, but those pages need to redirect.
      p.subtitle.is-size-3-desktop.is-size-5-touch(v-if="targetPage !== 'error'") Take a Coffee, Hold on, It will redirect to there.

      p.subtitle.is-size-3-desktop.is-size-5-touch.mb-0(
        v-if="targetPage === 'error'"
      ) Hmm, What is the page gone?
...
export default {
  ...
  computed: {
    ...
    message() {
      return this.error ? this.error.message : "Unknown Error Occur";
    },
    targetPage() {
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: "og:url",
          property: "og:url",
          content: "https://stvchm9703.github.io/",
        },
        {
          hid: "og:image",
          property: "og:image",
